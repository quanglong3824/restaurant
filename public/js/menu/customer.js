...
function showPaymentOverlay() {
    ...
    if (!overlay) {
        ...
        overlay.innerHTML = `
            ...
            <h3 style="color:#1e293b; font-weight:800; font-family:'Playfair Display', serif; text-align:center;">Processing Payment</h3>
            <p style="color:#64748b; font-size:0.9rem; margin-top:10px; text-align:center; max-width:80%;">Please wait for staff to bring the bill to your table.<br>Page will auto-redirect when completed!</p>
        `;
