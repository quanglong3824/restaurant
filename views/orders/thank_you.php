<div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 80vh; text-align: center; padding: 20px;">
    ...
    <div style="background: white; padding: 40px; border-radius: 20px; box-shadow: 0 10px 40px rgba(0,0,0,0.05); max-width: 400px; width: 100%; border: 1px solid var(--border);">
        ...
        <h2 class="playfair" style="color: var(--text-dark); margin-bottom: 10px; font-weight: 800; font-size: 1.8rem;">Payment Successful!</h2>
        ...
        <h4 style="font-size: 1rem; color: var(--text-dark); font-weight: 700; margin-bottom: 15px;">Rate your experience</h4>
...
<script>
    function rate(stars) {
        ...
        const msgs = [
            'Very Bad', 'Bad', 'Normal', 'Satisfied', 'Excellent! Thank you!'
        ];
